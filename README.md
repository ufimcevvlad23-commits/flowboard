...
- сотрудники с необязательным email и назначение нескольких ответственных на задачу;
- сворачивание и быстрое разворачивание отдельных колонок;
- ручное закрытие и повторное открытие задач — закрытые задачи автоматически уходят вниз колонки;
