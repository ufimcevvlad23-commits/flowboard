...
import { CalendarDays, CheckCircle2, ListChecks, SearchX, UsersRound } from "lucide-react";
  ...
  return (
    <div className="task-table-wrap">
      <table className="task-table">
        <thead><tr><th>Задача</th><th>Список</th><th>Ответственные</th><th>Статус</th><th>Приоритет</th><th>Дедлайн</th><th>Метки</th></tr></thead>
        <tbody>
